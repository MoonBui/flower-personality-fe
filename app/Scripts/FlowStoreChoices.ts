...
const question3Choices: ChoiceOption[] = [
  ...
  },
  {
    ...
    additionalText: ["So I definitely feel like I need some help with expanding"]
  },
  {
    id: "3.3",
    score: 0,
...
const question4Choices: ChoiceOption[] = [
  {
    ...
    additionalText: ["Should be able to dedicate a good chunk of my time every week"]
  },
  {
    id: "4.2",
    score: 0,
    text: "On and off, it depends on the day",
    additionalText: ["My schedule's a bit hectic right now", "So I'd say maybe only around 10'-30' per day"]
  },
  {
    id: "4.3",
    score: 0,
...
const question8Choices: ChoiceOption[] = [
  ...
  },
  {
    ...
    additionalText: ["If it's really necessary then I can make some more wiggle room"]
  },
  {
    id: "8.3",
    score: 0,
